...
public class WeChatLoader {
	...
	private static final String WECHAT_MESSAGE_LIST_URL_1 = "https://mp.weixin.qq.com/cgi-bin/message?t=message/list&count=20&day=7&token=";
	private static final String WECHAT_MESSAGE_LIST_URL_2 = "&lang=zh_CN";

	private static final String WECHAT_MESSAGE_LOAD_PAGE_URL_1 = "https://mp.weixin.qq.com/cgi-bin/message?t=message/list&action=&keyword=&frommsgid=";
	private static final String WECHAT_MESSAGE_LOAD_PAGE_URL_2 = "&offset=";
	private static final String WECHAT_MESSAGE_LOAD_PAGE_URL_3 = "&count=20&day=7&token=";
	private static final String WECHAT_MESSAGE_LOAD_PAGE_URL_4 = "&lang=zh_CN";

	private static final String WECHAT_MESSAGE_REPLY_URL = "https://mp.weixin.qq.com/cgi-bin/singlesend";

	private static final String WECHAT_MESSAGE_STAR_URL = "https://mp.weixin.qq.com/cgi-bin/setstarmessage";

	private static final String WECHAT_MESSAGE_MASS_URL = "https://mp.weixin.qq.com/cgi-bin/masssend";

	private static final String WECHAT_GET_MESSAGE_PROFILE_IMG_URL_1 = "https://mp.weixin.qq.com/cgi-bin/getheadimg?token=";
	private static final String WECHAT_GET_MESSAGE_PROFILE_IMG_URL_2 = "&fakeid=";
	...
	private static final String WECHAT_GET_MASS_DATA_URL_1 = "https://mp.weixin.qq.com/cgi-bin/masssendpage?t=mass/send&token=";

	private static final String WECHAT_GET_MASS_DATA_URL_2 = "&lang=zh_CN";

	private static final String WECHAT_GET_MESSAGE_IMG_URL_1 = "https://mp.weixin.qq.com/cgi-bin/getimgdata?token=";
	private static final String WECHAT_GET_MESSAGE_IMG_URL_2 = "&msgid=";
	private static final String WECHAT_GET_MESSAGE_IMG_URL_3 = "&mode=";
	private static final String WECHAT_GET_MESSAGE_IMG_URL_4 = "&source=&fileId=0";
	
	public static final String WECHAT_MESSAGE_IMG_LARGE = "large";

	public static final String WECHAT_MESSAGE_IMG_SMALL = "small";
	...
	public static void wechatLogin(
		...
		new Thread() {
			public void run() { Looper.prepare();
				...
				HttpResponse response = httpPost(WECHAT_LOGIN_URL, headerList,
						params);
	...
	public static void wechatGetMessageList(
		...
		new Thread() {
			public void run() { Looper.prepare();
				...
				headerList.add(new BasicNameValuePair("Content-Type",
						"text/html; charset=utf-8"));
				String targetUrl = WECHAT_MESSAGE_LIST_URL_1
						+ userBean.getToken() + WECHAT_MESSAGE_LIST_URL_2;
	...
	public static void wechatGetMessagePage(
		...
		new Thread() {
			public void run() { Looper.prepare();
				...
				String targetUrl = WECHAT_MESSAGE_LOAD_PAGE_URL_1
						+ messageHolder.getLatestMsgId()
						+ WECHAT_MESSAGE_LOAD_PAGE_URL_2 + offset
						+ WECHAT_MESSAGE_LOAD_PAGE_URL_3
	...
	public static void wechatMessageReply(
		...
		new Thread() {
			public void run() { Looper.prepare();
				...
				String targetUrl = WECHAT_MESSAGE_REPLY_URL;
		...
		new Thread() {
			public void run() { Looper.prepare();
				...
				paramArrayList.add(new BasicNameValuePair("token", userBean
						.getToken()));
				paramArrayList.add(new BasicNameValuePair("lang", "zh_CN"));
				String targetUrl = WECHAT_MESSAGE_STAR_URL;
				HttpResponse response = httpPost(targetUrl, headerList,
						paramArrayList);
	...
	public static void wechatGetHeadImg(
		...
		new Thread() {
			public void run() { Looper.prepare();
				...
				String targetUrl = WECHAT_GET_MESSAGE_PROFILE_IMG_URL_1
						+ userBean.getToken()
						+ WECHAT_GET_MESSAGE_PROFILE_IMG_URL_2 + fakeId;
				HttpResponse response = httpGet(targetUrl, headerList);
				if (response != null) {
	...
	public static void wechatGetMessageImg(
		...
		new Thread() {
			public void run() { Looper.prepare();
				...
				String targetUrl = WECHAT_GET_MESSAGE_IMG_URL_1 + token+WECHAT_GET_MESSAGE_IMG_URL_2+msgId+WECHAT_GET_MESSAGE_IMG_URL_3+imgType+WECHAT_GET_MESSAGE_IMG_URL_4;
				HttpResponse response = httpGet(targetUrl, headerList);
				if (response != null) {
	...
	public static void wechatGetUserProfile(final WechatExceptionListener wechatExceptionListener,
		...
		new Thread() {
			public void run() { Looper.prepare();
				...
				headerList.add(new BasicNameValuePair("Content-Type",
						"text/html; charset=utf-8"));
				String targetUrl = WECHAT_GET_USER_PROFILE_URL
						+ userBean.getToken();
				HttpResponse response = httpGet(targetUrl, headerList);
