...
public class AboutActivity extends Activity {
	...
	private void initWidgets() {
		...
		String source = 
	"<p>&nbsp;&nbsp;公众平台小助手是一款非官方的微信公众平台管理应用，由@华中科技大学联创团队 三名大学生完成。一直以来在手机上对微信公众平台进行管理都是一个令人困扰的问题，我们这样一个工具能够帮您解决一些苦恼。</p>"+
	...
	"<p>A：公众平台助手是由华中科技大学联创团队三名大三学生制作，不属于微信官方的产品，但可以作为微信公众平台的一个补充来使用。</p>"+
	...
	"<p>A：出发点很简单：我们在需要一个可以让我们在手机上管理微信公众平台的东西。一开始我们觉得微信自己迟早会推出，但是没有，所以只有自己来了。做这一切的目的就是让微信公众平台更好用。往大一点说，可以认为我们试图更加完善微信的生态，也因此一些破坏微信生态的事情是我们不愿意做的。</p>"+
	"<p><strong>Q：你们会做微信相关的外包吗？</strong></p>"+
	"<p>A：还有更多有趣的事情等着我们去做：）</p>"+
	"<p><strong>Q：你们是谁？除了公众平台助手你们还有什么其他的产品吗？</strong></p>"+
	"<p>A：我们三个都是华中科技大学联创团队的成员。联创团队近期做过的东西包括Fuubo、Tuudo、华中科技大学官方微信（华小科）的技术实现 等。今年六月我们与豌豆荚合作举办了全国首届校园Hackday。PS，联创团队不是一个创业团队，是一个学生技术团队。想要查看更多关于联创的信息请登陆网站：www.hustunique.com</p>"+
